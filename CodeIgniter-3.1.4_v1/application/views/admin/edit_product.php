					 ...
					 <!-- content starts here-->
							 ...
							 <div id="prod_details">
								...
								<div style="margin-left: 5px" class="table-responsive">
								 <form method="post" action="<?php echo base_url('signedin/do_update/'.$value->p_name);?>" enctype="multipart/form-data">
								  	<table class="table" >
								  		 <tbody>
									      <tr>
												 <td><div class="form-group">
													  <label >Product Name:</label>
													  <input type="text" class="form-control" value="<?php echo $value->p_name; ?>" id="p_name" name="p_name">
													</div></td>
											 	 <td>
										  ...
										  <tr>
										    ...
										    <textarea cols="5" id="discription" name="discription"><?php echo $value->discription; ?></textarea>
										    </td>
										  </tr>
										  <tr>
										  <th>Pricing</th>
										  ...
										  <tr>
												 <td>
												 	<div class="form-group">
													  ...
													  <input type="text" class="form-control" name="o_price" id="o_price" value="<?php echo $value->o_price; ?>">
													</div>
													<div class="form-group">
													  <label >Retails price:</label>
													  <input type="text" class="form-control" name="r_price" id="r_price" value="<?php echo $value->r_price; ?>">
													</div>
													<div class="form-group">
													  <label >Sale Price:</label>
													  <input type="text" class="form-control" id="s_price" name="s_price" value="<?php echo $value->s_price; ?>">
													</div>
													<div class="form-group">
													  <label >Cost Price:</label>
													  <input type="text" class="form-control" id="c_price" name="c_price" value="<?php echo $value->c_price; ?>">
													</div>
													<div class="form-group">
													  <label >SRP:</label>
													  <input type="text" class="form-control" id="srp" name="srp" value="<?php echo $value->srp; ?>">
													</div>
												 </td>
											 	 <td>
										  ...
										  <a href="<?php echo base_url('Signedin/view_product');?>" class="btn btn-info">Cancel</a>
										  </td>
										  </tr></center>
