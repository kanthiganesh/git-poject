...
<div class="w3-yellow">
  <div class="container-fluid">
    <div class="navbar-header">
	  ...
	  <li class="space"><a href="#" class="cart"><span class="fa fa-shopping-cart " style="font-size:12px">&nbsp;</span>Cart&nbsp;<span class="badge white">1</span></a></li>
...
<h4 style="margin:50px 0px 0px 110px"; text-decoration:none">HOME/STORE/PRODUCT STORE</h4>
    ...
    <div class="col-md-1"
      <div>
          ...
          <img src="<?php echo base_url('uploads/e.jpg');?>" style="width:100%;margin:20px 40px 0px 90px"><br />
		  <img src="<?php echo base_url('uploads/bo.jpg');?>" style="width:100%;margin:10px 20px 0px 90px"> <br />
		  <img src="<?php echo base_url('uploads/nm.jpg');?>" style="width:100%; margin:10px 20px 0px 90px"><br/>
		  <img src="<?php echo base_url('uploads/box.jpg');?>" style="width:100%; margin:10px 20px 0px 90px"><br/><br/>
    ...
    <div class="col-md-3">
      <div class="thumbnail" style="margin:20px 20px 200px 90px">
          ...
          <img src="<?php echo base_url('uploads/8.jpg');?>" alt="Fjords" style="width:300px; height:300px">
      </div>
    </div>
  ...
  <option value="audi">20</option>
	 ...
	 <p><button type="button" style="background-color:#2F4F4F" class="btn btn-primary active" onclick="window.location='<?php echo site_url("Select_product/add_to_cart/");?>'"><strong>ADD TO CART</strong></button>
	 <a href="third.html"><button type="button" style="background-color:#FF4500" class="btn btn-primary disabled"><strong>CUSTOMIZE</strong></button></p></a><br/><br/>
	 <p><h3>Related Products<h3></p>
	 <div style ="width:100%">
		<div style ="float:left; width:60%">
		</div>
		<div style="float:right; margin:-420px 35px 0px 0px;height:300px;width:300px">
		<table><tr>
		<td style="background-color:#707070;font-size:11px;text-color:white;height:250px;width:250px" class="table-responsive" >
  ...
  <table><tr><th>
	  <div style="margin-left:-300px"><img style="width:200px; height:200px;margin:20px 20px 20px 40px" class="img-responsive" src="<?php echo base_url('uploads/pen.jpeg');?>"></th><th><img style="width:200px; height:200px;margin:20px 10px 20px 20px" class="img-responsive" src="<?php echo base_url('uploads/j.jpg');?>"></th>
	 <th><img style="width:200px; height:200px;margin:20px 10px 20px 20px" class="img-responsive" src="<?php echo base_url('uploads/book.jpg');?>"></th><th> <img style="width:200px; height:200px;margin:20px 10px 20px 20px" class="img-responsive" src="<?php echo base_url('uploads/d.jpg');?>"></div></th>
	  </div>
