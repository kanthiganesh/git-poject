...
<h4 style="margin:40px 0px 0px 110px">HOME/STORE</h4>
	 ...
	 <table><tr><th>
	<a href="second.html"><img style="width:200px; height:190px; margin:15px 20px 20px 100px" class="img-responsive" src="1.jpg"></a></th>
	 
	 <th><a href="second.html"><img style="width:200px; height:190px; margin:15px 10px 20px 20px" class="img-responsive" src="2.jpg"></a></th>
	<th><a href="second.html"><img style="width:200px; height:190px;margin:15px 10px 20px 20px" class="img-responsive" src="6.jpg"></a></th> <th>
	<a href="second.html"><img style="width:200px; height:190px; margin:15px 10px 20px 20px" class="img-responsive" src="5.jpg"></a></th>
	...
	<table><tr><th>
	  <div><a href="second.html"><img style="width:200px; height:190px;margin:15px 20px 20px 100px" class="img-responsive" src="1.jpg"></a></th>
	  <th><a href="second.html"><img style="width:200px; height:190px;margin:15px 10px 20px 20px" class="img-responsive" src="2.jpg"></a></th>
	 <th><a href="second.html"><img style="width:200px; height:190px;margin:15px 10px 20px 20px" class="img-responsive" src="6.jpg"></a></th>
	 <th><a href="second.html"><img style="width:200px; height:190px;margin:15px 10px 20px 20px" class="img-responsive" src="5.jpg"></a></div></th>
	, <tr><td><p style="margin:-15px 0px 0px 100px">Standard Student kit</p>
	 <p style="margin:-5px 0px 0px 100px"><strong>Rs 1499/ </strong></p>
